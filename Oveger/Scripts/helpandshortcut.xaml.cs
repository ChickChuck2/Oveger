...
namespace Oveger.XAMLS
{
    ...
    public partial class Helpandshortcut : Window
    {
        ...
        {
            ConfigManager.ChangeHotkeys(
                (System.Windows.Forms.Keys)Enum.Parse(typeof(System.Windows.Forms.Keys), keybox.Text), 
                (MainWindow.Modifiers)Enum.Parse(typeof(MainWindow.Modifiers), mod1box.Text), 
                (MainWindow.Modifiers)Enum.Parse(typeof(MainWindow.Modifiers), mod2box.Text));
            Close();
            Thread.Sleep(300);
